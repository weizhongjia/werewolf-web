<template>
  <div id="gameOver">
    ...
    <div>
      ...
      <div id="goodPerson">
        ...
        <div class="content">
          ...
          <div class="every">
            <div class="touX"></div>
            <p class="num">2</p>
            <img src="../../../assets/images/waring.png" alt="" class="waring">
            <div class="role">
      ...
      <div class="btmBtn">
        <div class="yes blue">返回大厅</div>
        <div class="yes blue">游戏复盘</div>
...
<style>
  ...
  #goodPerson .gradient{
    background: #0b69c3;
    background: linear-gradient(to right,#1b2330 , #0b69c3 ,#1b2330);
  }
  #wereWolf .gradient{
    background: #ba3023;
